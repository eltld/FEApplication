...
* {@link #fitSystemWindows(android.graphics.Rect)}, i.e. the area above UI chrome
...
public class ScrimInsetsFrameLayout extends FrameLayout {
     ...
     * processing when insets change (i.e. when {@link #fitSystemWindows(android.graphics.Rect)}
